...
export default function TabLayout() {
  ...
  useEffect(() => {
    console.log('TabLayout useEffect - isLoading:', isLoading, 'isAuthenticated:', isAuthenticated, 'hasRedirected:', hasRedirected.current);
    ...
    if (isAuthenticated === true && hasRedirected.current) {
